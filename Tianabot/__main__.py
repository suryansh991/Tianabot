...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="𝘿𝙤𝙣𝙖𝙩𝙚 💰", url="https://t.me/DarkestXmarket666"),
    ],
   [
        InlineKeyboardButton(text="📇 𝙐𝙥𝙙𝙖𝙩𝙚𝙨", url=f"http://t.me/{DarkestXmarket666}"),
        InlineKeyboardButton(text="𝙎𝙪𝙥𝙥𝙤𝙧𝙩 🫂", url=f"https://t.me/{DarkestMarket666}"),
    ],
    [  
